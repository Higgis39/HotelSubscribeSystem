...
import Hotel模块.update.MockHotel;
...
public class testUpdate {
	...
	public void test() {
		...
		OrderPO order1 = new OrderPO(98701, "11.12", "11.12", "12:00", "Unfinished", "���", 128, "");
		OrderPO order2 = new OrderPO(98702, "11.12", "11.12", "12:00", "Unfinished", "���", 158, "");
		OrderPO order3 = new OrderPO(98703, "11.12", "11.12", "16:00", "Unfinished", "���", 128, "");
		OrderPO order4 = new OrderPO(98704, "11.12", "11.12", "16:00", "Unfinished", "���", 158, "");
		OrderPO order5 = new OrderPO(98705, "11.12", "11.12", "18:00", "Unfinished", "���", 128, "");
